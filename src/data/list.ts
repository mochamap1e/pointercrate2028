...
export const list: ListLevel[] = [
    ...
    },
    {
        ...
        videoId: "",
        verifier: users[1],
        victors: [users[0], users[3], users[4], users[5]],
        tier: 1,
        levelId: 13519
    },
];
